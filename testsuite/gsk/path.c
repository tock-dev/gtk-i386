                            ...
                            float           position)
{
  ...
  gsk_path_get_closest_point (gsk_path_measure_get_path (measure2), &p, INFINITY, &point, NULL);
  gsk_path_point_get_position (&point, gsk_path_measure_get_path (measure2), &s);
