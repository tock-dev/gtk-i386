                                   ...
                                   const graphene_rect_t *opaque)
{
  ...
  g_assert (priv->color_volume == NULL);
...
/*<private>
 * gdk_draw_context_get_color_volume:
 * @self: a `GdkDrawContext`
 *
 * Gets the target color_volume while rendering.
 *
 * If no rendering is going on, %NULL is returned.
 *
 ...
 **/
GdkColorVolume *
gdk_draw_context_get_color_volume (GdkDrawContext *self)
{
  GdkDrawContextPrivate *priv = gdk_draw_context_get_instance_private (self);
