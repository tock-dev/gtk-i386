                       ...
                       Context      *context)
{
  ...
  const Declaration declarations[] = {
    { "factors", parse_four_floats, NULL, factors },
  ...
  result = gsk_arithmetic_node_new (first, second, factors);
    ...
    case GSK_ARITHMETIC_NODE:
      {
        ...
        append_four_float_param (p, "factors", factors[0], factors[1], factors[2], factors[3]);
