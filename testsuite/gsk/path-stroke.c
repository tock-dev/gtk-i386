                          ...
                          float           position)
{
  ...
  gsk_path_measure_get_point (measure, position, &point);
  gsk_path_point_get_position (&point, gsk_path_measure_get_path (measure), &p);
  gsk_path_get_closest_point (gsk_path_measure_get_path (stroke_measure), &p, INFINITY, &point, NULL);
  gsk_path_point_get_position (&point, gsk_path_measure_get_path (stroke_measure), &s);
