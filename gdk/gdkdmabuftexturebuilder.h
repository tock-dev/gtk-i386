...
GdkColorVolume *         gdk_dmabuf_texture_builder_get_color_volume   (GdkDmabufTextureBuilder  *self) G_GNUC_PURE;
GDK_AVAILABLE_IN_4_18
void                     gdk_dmabuf_texture_builder_set_color_volume   (GdkDmabufTextureBuilder  *self,
