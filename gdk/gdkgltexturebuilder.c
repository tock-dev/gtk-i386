                                     ...
                                     GParamSpec   *pspec)
{
  ...
  switch (property_id)
    ...
    case PROP_COLOR_VOLUME:
      gdk_gl_texture_builder_set_color_volume (self, g_value_get_boxed (value));
      break;
...
gdk_gl_texture_builder_class_init (GdkGLTextureBuilderClass *klass)
{
  ...
  /**
   * GdkGLTextureBuilder:color-volume:
   *
...
/**
 * gdk_gl_texture_builder_get_color_volume:
 * @self: a `GdkGLTextureBuilder`
 *
 * Gets the color volume previously set via gdk_gl_texture_builder_set_color_volume().
 *
 ...
 */
GdkColorVolume *
gdk_gl_texture_builder_get_color_volume (GdkGLTextureBuilder *self)
{
  g_return_val_if_fail (GDK_IS_GL_TEXTURE_BUILDER (self), NULL);
...
/**
 * gdk_gl_texture_builder_set_color_volume:
 * @self: a `GdkGLTextureBuilder`
 ...
 */
void
gdk_gl_texture_builder_set_color_volume (GdkGLTextureBuilder *self,
                                         GdkColorVolume      *color_volume)
{
  g_return_if_fail (GDK_IS_GL_TEXTURE_BUILDER (self));
